...
function loadGoal(goalId) {
    ...
    setBreadcrumb([
        ...
        { label: goal.name, url: `/pages/GoalDashboard.html` },
        { i18nKey: 'edit' }
    ])
    ...
    deleteBtn.addEventListener('click', () => {
        showConfirm(I18n.t('goalDeleteConfirm'), () => {
            $.ajax({
                ...
                success: () => { clearDirtyGuard(); navigateWithToast('/pages/GoalDashboard.html', I18n.t('goalDeletedSuccess'), 'success') },
    ...
    archiveBtn.addEventListener('click', () => {
        showConfirm(I18n.t('goalArchiveConfirm'), () => {
            $.ajax({
                ...
                success: () => { clearDirtyGuard(); navigateWithToast('/pages/GoalDashboard.html', I18n.t('goalArchivedSuccess'), 'success') },
