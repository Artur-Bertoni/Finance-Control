...
export function init() {
    ...
    if (!goalId) { navigate('/pages/lists/GoalList.html'); return }
        ...
        archiveBtn.addEventListener('click', () =>
            showConfirm(I18n.t('goalArchiveConfirm'), () => {
                $.ajax({
                    ...
                    success: () => navigateWithToast('/pages/lists/GoalList.html', I18n.t('goalArchivedSuccess'), 'success'),
    ...
    document.getElementById('edit-btn').addEventListener('click', () =>
        navigate(`/pages/crud/Goal.html?id=${goalId}`)
    )
