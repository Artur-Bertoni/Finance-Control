...
public class ChangeHistoryService {
    ...
    public List<ChangeGroupResponse> getHistory(String entityType, Long entityId) {
    ...
    // -----------------------------------------------------------------------
    // Diff utilities for use in services
    // -----------------------------------------------------------------------
    ...
    public static String[] diff(String oldVal, String newVal) {
        return new String[]{ blankToNull(oldVal), blankToNull(newVal) };
    }

    public static String[] diff(Object oldVal, Object newVal) {
        return new String[]{
